...
const projects = [
    ...
    },
    {
        title: 'MissAstroGlow',
        category: 'Apps',
        description: 'A full stack AI product, from user research to launch, spanning an AI chat app, booking platform, and autonomous agents handling lead outreach and follow ups. Grew to 22K Instagram and 42K Snapchat organically.',
        featured: false,
